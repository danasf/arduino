...
#define APIKEY         "xxxxxxx" // replace your Xively api key here
#define FEEDID         111111111 // replace your feed ID
#define USERAGENT      "My Temperature Sensor 001" // user agent is the project name
...
float measureDust () {
  ...
  // Airquality linear equation from http://www.howmuchsnow.com/arduino/airquality/
  // Chris Nafis (c) 2012
